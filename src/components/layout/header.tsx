...
import { LogOut, Gamepad2, User, ChevronDown } from "lucide-react";
            ...
            <div className="flex items-center gap-4">
                ...
                {user ? (
                    ...
                    <button
                        ...
                        className="group relative px-6 py-2.5 rounded-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium transition-all shadow-lg shadow-[#5865F2]/20 hover:shadow-[#5865F2]/40 overflow-hidden"
                    >
                        ...
                        <div className="flex items-center gap-2 relative z-10">
                            <Gamepad2 className="w-5 h-5 transition-transform group-hover:scale-110 group-active:scale-95" />
