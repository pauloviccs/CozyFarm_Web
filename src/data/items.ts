...
export const ITEMS: Item[] = [
  ...
  // ========== HYTALE - CROPS & PLANTS ==========
  { id: "hy-carrot", name: "Carrot", namePt: "Cenoura", game: "hytale", category: "crops", source: "Mature Carrot" },
  { id: "hy-wheat", name: "Wheat", namePt: "Trigo", game: "hytale", category: "crops", source: "Mature Wheat" },
  { id: "hy-tomato", name: "Tomato", namePt: "Tomate", game: "hytale", category: "crops", source: "Mature Tomato" },
  { id: "hy-corn", name: "Corn", namePt: "Milho", game: "hytale", category: "crops", source: "Mature Corn" },
  { id: "hy-pumpkin", name: "Pumpkin", namePt: "Abóbora", game: "hytale", category: "crops", source: "Mature Pumpkin" },
  { id: "hy-turnip", name: "Turnip", namePt: "Nabo", game: "hytale", category: "crops", source: "Mature Turnip" },
  { id: "hy-potato", name: "Potato", namePt: "Batata", game: "hytale", category: "crops", source: "Mature Potatoes" },
  { id: "hy-chilli", name: "Chilli", namePt: "Pimenta", game: "hytale", category: "crops", source: "Mature Chilli" },
  { id: "hy-lettuce", name: "Lettuce", namePt: "Alface", game: "hytale", category: "crops", source: "Mature Lettuce" },
  { id: "hy-onion", name: "Onion", namePt: "Cebola", game: "hytale", category: "crops", source: "Mature Onions" },
  { id: "hy-cauliflower", name: "Cauliflower", namePt: "Couve-flor", game: "hytale", category: "crops", source: "Mature Cauliflower" },
  { id: "hy-aubergine", name: "Aubergine", namePt: "Berinjela", game: "hytale", category: "crops", source: "Mature Aubergine" },
  { id: "hy-cotton", name: "Cotton", namePt: "Algodão", game: "hytale", category: "crops", source: "Mature Cotton" },
  { id: "hy-rice", name: "Rice", namePt: "Arroz", game: "hytale", category: "crops", source: "Mature Rice" },
  { id: "hy-apple", name: "Apple", namePt: "Maçã", game: "hytale", category: "crops", source: "Mature Apple" },
  { id: "hy-wild-berries", name: "Wild Berries", namePt: "Frutos Silvestres", game: "hytale", category: "forage" },
  { id: "hy-sunflower", name: "Sunflower", namePt: "Girassol", game: "hytale", category: "crops" },
  { id: "hy-blood-rose", name: "Blood Rose", namePt: "Rosa Sangrenta", game: "hytale", category: "crops" },
  { id: "hy-storm-thistle", name: "Storm Thistle", namePt: "Cardo da Tempestade", game: "hytale", category: "crops" },
  { id: "hy-azure-kelp", name: "Azure Kelp", namePt: "Alga Azul", game: "hytale", category: "crops" },
  { id: "hy-azure-fern", name: "Azure Fern", namePt: "Samambaia Azul", game: "hytale", category: "crops" },

  // ========== HYTALE - SEEDS ==========
  { id: "hy-carrot-seed", name: "Carrot Seed Bag", namePt: "Saco de Sementes de Cenoura", game: "hytale", category: "seeds" },
  { id: "hy-wheat-seed", name: "Wheat Seed Bag", namePt: "Saco de Sementes de Trigo", game: "hytale", category: "seeds" },
  { id: "hy-tomato-seed", name: "Tomato Seed Bag", namePt: "Saco de Sementes de Tomate", game: "hytale", category: "seeds" },
  { id: "hy-corn-seed", name: "Corn Seed Bag", namePt: "Saco de Sementes de Milho", game: "hytale", category: "seeds" },
  { id: "hy-pumpkin-seed", name: "Pumpkin Seed Bag", namePt: "Saco de Sementes de Abóbora", game: "hytale", category: "seeds" },
  { id: "hy-turnip-seed", name: "Turnip Seed Bag", namePt: "Saco de Sementes de Nabo", game: "hytale", category: "seeds" },
  { id: "hy-chilli-seed", name: "Chilli Seed Bag", namePt: "Saco de Sementes de Pimenta", game: "hytale", category: "seeds" },
  { id: "hy-lettuce-seed", name: "Lettuce Seed Bag", namePt: "Saco de Sementes de Alface", game: "hytale", category: "seeds" },
  { id: "hy-rice-seed", name: "Rice Seed Bag", namePt: "Saco de Sementes de Arroz", game: "hytale", category: "seeds" },
  { id: "hy-onion-bulb", name: "Onion Bulb", namePt: "Bulbo de Cebola", game: "hytale", category: "seeds" },
  { id: "hy-cauliflower-seed", name: "Cauliflower Seed Bag", namePt: "Saco de Sementes de Couve-flor", game: "hytale", category: "seeds" },
  { id: "hy-aubergine-seed", name: "Aubergine Seed Bag", namePt: "Saco de Sementes de Berinjela", game: "hytale", category: "seeds" },
  { id: "hy-cotton-seed", name: "Cotton Seed Bag", namePt: "Saco de Sementes de Algodão", game: "hytale", category: "seeds" },
  { id: "hy-sunflower-seed", name: "Sunflower Seed Bag", namePt: "Saco de Sementes de Girassol", game: "hytale", category: "seeds" },
  { id: "hy-blood-rose-seed", name: "Blood Rose Seed Bag", namePt: "Saco de Sementes de Rosa Sangrenta", game: "hytale", category: "seeds" },
  { id: "hy-storm-thistle-seed", name: "Storm Thistle Seed Bag", namePt: "Saco de Sementes de Cardo", game: "hytale", category: "seeds" },
  { id: "hy-palm-seed", name: "Palm Seed Bag", namePt: "Saco de Sementes de Palmeira", game: "hytale", category: "seeds" },
  { id: "hy-azure-kelp-seed", name: "Azure Kelp Seed Bag", namePt: "Saco de Sementes de Alga Azul", game: "hytale", category: "seeds" },
  { id: "hy-azure-fern-seed", name: "Azure Fern Seed Bag", namePt: "Saco de Sementes de Samambaia Azul", game: "hytale", category: "seeds" },

  // ========== HYTALE - MATERIALS ==========
  { id: "hy-plant-fiber", name: "Plant Fiber", namePt: "Fibra Vegetal", game: "hytale", category: "materials" },
  { id: "hy-stick", name: "Stick", namePt: "Graveto", game: "hytale", category: "materials" },
  { id: "hy-tree-sap", name: "Tree Sap", namePt: "Seiva de Árvore", game: "hytale", category: "materials" },
  { id: "hy-tree-bark", name: "Tree Bark", namePt: "Casca de Árvore", game: "hytale", category: "materials" },
  { id: "hy-moss", name: "Moss", namePt: "Musgo", game: "hytale", category: "materials" },
  { id: "hy-petals", name: "Petals", namePt: "Pétalas", game: "hytale", category: "materials" },
  { id: "hy-hive", name: "Hive", namePt: "Colmeia", game: "hytale", category: "materials" },
  { id: "hy-pinecone", name: "Pinecone", namePt: "Pinha", game: "hytale", category: "materials" },
  { id: "hy-sap-glob", name: "Sap Glob", namePt: "Globo de Seiva", game: "hytale", category: "materials" },
];
